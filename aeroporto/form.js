...
// Importando o serviço corrigido da API do IBGE
...
const form = () => {
  ...
  // Estado para armazenar a lista de estados vinda da API do IBGE
  ...
  useEffect(() => {
    ...
    // Chamada assíncrona para buscar as UFs diretamente da API do IBGE
  ...
  return (
    <Pagina titulo="Cadastro de Aeroporto" typeNavBar="adm">
      <Form className="mt-3">
        ...
        <Row>
          {/* CAMPO SUBSTITUÍDO: Saiu o input de texto de "Cidade" e entrou o select do IBGE */}
          <Col md={6}>
            <Form.Group className="mb-3" controlId="estado">
              <Form.Label>Estado (UF):</Form.Label>
              <Form.Select
                isInvalid={!!errors.estado}
                {...register("estado", { required: "Selecione o estado do aeroporto" })}
              >
