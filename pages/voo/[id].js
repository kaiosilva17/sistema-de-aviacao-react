...
const form = () => {
  ...
  const horarioEmbarque = watch("horario_embarque");
  ...
  return (
    <>
      <Pagina titulo="Gerenciamento Voos" typeNavBar="adm">
        <Form className="mt-3">
          <Row>
            <Col md={4}>
          ...
          <Form.Group className="mb-3" controlId="portao">
            ...
            <Form.Control
              ...
              placeholder="Ex: G7 (Letra e Número)"
              type="text"
              {...register("portao", {
                ...vooValidator.portao,
                pattern: {
                  value: /^[A-Z][0-9]$/i,
                  message: "Use o formato Letra e Número (ex: B3)",
                },
              })}
            />
            <Form.Control.Feedback type="invalid">
